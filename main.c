...
//Bu kod, kullanýcýdan iki non-negatif tam sayý alýr (sýrasýyla num1 ve num2), ardýndan while döngüsünü kullanarak sýfýra ulaþana kadar sayar. if koþulu, num1 >= num2 ise num2'yi num1'den çýkarýr, aksi takdirde num1'i num2'den çýkarýr. Her iþlem yapýldýðýnda, count deðiþkeni bir artýrýlýr. Döngü bittiðinde, gereken iþlem sayýsý count deðiþkeni ile yazdýrýlýr.
